...
namespace craft\stripe\feedme\fields;
 ...
 * @since 1.4.0
 */
class Subscriptions extends Field implements FieldInterface
{
    /**
     * @var string
     */
    public static string $name = 'StripeSubscriptions';

    /**
     * @var string
     */
    public static string $class = SubscriptionsField::class;

    /**
     * @var string
     */
    public static string $elementType = SubscriptionElement::class;
    ...
    {
        return 'stripe/_feedme/fields/subscriptions';
    }
    ...
    public function parseField(): mixed
    {
        ...
        $specialMatchCase = in_array($match, ['title', 'stripeId', 'id']);
        ...
        foreach ($value as $dataValue) {
            ...
            $query = SubscriptionElement::find();
