 ...
 * @since 1.4.0
 */
class Products extends Field implements FieldInterface
{
    /**
     * @var string
     */
    public static string $name = 'StripeProducts';
    ...
    {
        return 'stripe/_feedme/fields/products';
    }
    ...
    public function parseField(): mixed
    {
        ...
        $specialMatchCase = in_array($match, ['title', 'slug', 'stripeId', 'id']);
